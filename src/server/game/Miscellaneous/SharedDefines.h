...
enum AttributesEx2
{
    ...
    SPELL_ATTR_EX2_NOT_RESET_AUTO_ACTIONS     = 0x00020000,       // 17 don't reset timers for melee autoattacks (swings) or ranged autoattacks (autoshots)
...
enum SpellCastResult
{
    ...
    SPELL_CAST_OK                               = 0xFF      // custom value, don't have be send to client
};
